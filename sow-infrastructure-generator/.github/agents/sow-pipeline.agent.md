...
│   └── Warning: 3 placeholders found (non-blocking)
├── 3. Commit changes
...
│   └── Build queued: #1234
└── 6. Return status
    └── Build URL: https://dev.azure.com/org/project/_build/results?buildId=1234
```
...
Stages:
✅ dev (completed - 2m 30s)
🔄 test (in progress - 1m 15s)
⏳ prod (pending)
...
Resources Deployed:
├─ Service Bus: contica-sdc-dev-sb01 ✅
├─ Storage: conticasdcdevst01 ✅
├─ Logic Apps: 3 apps ✅
├─ Function Apps: 1 app ✅
├─ Key Vault: contica-sdc-dev-kv01 ✅
