...
10. [Sales Opportunities](#10-sales-opportunities) *(Internal Only)*
...
0. **Preflight Validation** — Environment and configuration verification
1. **Discovery** — Resource inventory and enumeration
2. **Logic Apps Deep Dive** — Workflow analysis and pattern identification
3. **Failure Analysis** — Run history review and root cause analysis
4. **Security Audit** — Security posture evaluation against SSOT standards
5. **Dead Flow Detection** — Identification of unused resources
6. **Monitoring Gaps** — Observability assessment
7. **Naming & Tagging** — Convention compliance review
8. **Report Generation** — Findings synthesis
9. **Sales Opportunities** — Service opportunity identification *(internal)*
...
- Atlassian MCP — Contica SSOT standards from Confluence
...
*Include this section only if `salesOpportunities.includeInReport == true` in client config.*
...
*This document is confidential and intended for {CLIENT_NAME} use only.*
